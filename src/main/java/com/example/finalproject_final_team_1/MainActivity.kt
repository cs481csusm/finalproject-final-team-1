...
class MainActivity : AppCompatActivity() {
    ...
    private fun permissionRequest(){
      var permissionList = mutableListOf<String>()
        if (!(ActivityCompat.checkSelfPermission(this,android.Manifest.permission.READ_CALENDAR) == PackageManager.PERMISSION_GRANTED)){
            permissionList.add(android.Manifest.permission.READ_CALENDAR)
        }
    ...
    private fun createNotificationChannel() {
        ...
        //notificationManager.createNotificationChannel(notificationManager.getNotificationChannel(4))
    }
